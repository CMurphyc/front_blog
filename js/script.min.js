!function () {
    ...
    window.PR_SHOULD_USE_CONTINUATION = !0, function () {
        ...
        function e(a) {
            for (var b = void 0, c = a.firstChild; c; c = c.nextSibling) var d = c.nodeType, b = 1 === d ? b ? a : c : 3 === d && v.test(c.nodeValue) ? a : b;
            return b === a ? void 0 : b
        }
    ...
    var a = Math.ceil($(window).height()) + 1, b = a - 100;
    $("header.stripe.full, header.stripe.full .text, header.stripe.full .text-center, header.stripe.full .text-center-tight").height(a), $("header.stripe.full .scroll-down").css({marginTop: b})
    ...
    $("header .scroll-down").on("click", function (b) {
        b.preventDefault(), $("header").velocity("scroll", {duration: 1e3, offset: a})
    })
