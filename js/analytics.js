(function () {
    ...
    var gb = qa(window.GoogleAnalyticsObject) && sa(window.GoogleAnalyticsObject) || "ga", Ba = !1, he = S("_br"),
    ...
    var ie = new Od(!0, he, 7), je = function (a) {
        if (!Ud() && !Ba) {
            ...
            if (b && !(!O.navigator.sendBeacon && 4 <= b && 6 >= b)) {
                ...
                a += [b, "A", c, d].join(".");
                var e = 1 != b % 3 ? "https:" : "http:", e = e + "//www.google-analytics.com/collect?z=br.",
                    e = e + [b, "B", c, d].join(".");
                ...
                if (d.i) {
                    ...
                    if (!ea(Yd.get(g)) && !$d.get(g)) {
                        ...
                        if (ca) {
                            ...
                            var k = l.protocol, w = M.location.protocol,
